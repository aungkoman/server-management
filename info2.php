...
$diskTotal = getCommandOutput("df -h --total | grep total | awk '{print $2}'");
$diskUsed = getCommandOutput("df -h --total | grep total | awk '{print $3}'");
$diskAvailable = getCommandOutput("df -h --total | grep total | awk '{print $4}'");
...
<body>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo htmlspecialchars($diskTotal); ?></td>
        </tr>
        <tr>
            <td>Used Disk Space</td>
            <td><?php echo htmlspecialchars($diskUsed); ?></td>
        </tr>
        <tr>
             <td>Available Disk Space</td>
             <td><?php echo htmlspecialchars($diskAvailable); ?></td>
        </tr>
        <tr>
            <td>Uptime</td>
